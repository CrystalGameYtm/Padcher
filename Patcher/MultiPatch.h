...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Size = System::Drawing::Size(506, 303);
			this->dataGridView1->TabIndex = 0;
			// 
			// button1
			// 
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12));
			this->button1->Location = System::Drawing::Point(202, 322);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(161, 43);
			this->button1->TabIndex = 1;
			this->button1->Text = L"_ _ _";
			...
			this->button2->Location = System::Drawing::Point(369, 323);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(150, 42);
			this->button2->TabIndex = 9;
			this->button2->Text = L"Пропатчити";
			...
			this->ClientSize = System::Drawing::Size(531, 377);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->dataGridView1);
			this->Name = L"MultiPatch";
			this->Text = L"MultiPatch";
